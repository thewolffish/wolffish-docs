...
This guide covers advanced patterns for capability plugins beyond the basics in [Creating Capabilities](/extending/creating-capabilities). These patterns handle real-world complexity: dependencies, long-running operations, state management, and multi-tool plugins.
