...
<Tip>
  The simplest way to hand someone a capability is to zip the folder and send it — they drop the `.zip` onto their Cellebrum panel and it's live. For ongoing distribution, push it to git instead (see [Community Capabilities](/extending/community-capabilities)).
</Tip>
