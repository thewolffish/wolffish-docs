...
|---|---|---|
| Debug snapshots | `brain/prefrontal/.debug/{timestamp}.md` | `prefrontal.buildContext()` |
...
<Card title="Diagnostic Export" icon="file-zipper" href="/debugging/diagnostic-export">
