...
Want parallel multi-agent work? Click the **mode pill** next to the model switch and pick [Workflow](/configuration/workflow-mode) — the agent can then plan phases and spawn parallel agents on any model you've connected.
