...
<iframe
  ...
  title="تفصيل السيرة الذاتية — عرض وولف فيش"
  frameBorder="0"
...
Claude Sonnet 4.6. يربط سير العمل هذا بين البحث على الويب واستراتيجية المحتوى والكتابة وإنشاء HTML/بي دي اف. يتعامل Sonnet معه بشكل جيد — مطابقة نبرة الشركة وتحديد ما يجب حذفه وإنتاج HTML منسق ونظيف — بجزء بسيط من تكلفة النماذج الأكبر.

### المتطلبات

- وولف فيش مثبت ويعمل.
- مفتاح Claude API متصل في الإعدادات > النماذج. اختر Claude Sonnet 4.6 أو أي نموذج قادر.
- سيرتك الذاتية الحالية محفوظة كملف بي دي اف على جهازك.
- الوصف الوظيفي للدور المستهدف — إما النص الكامل منسوخاً من الإعلان، أو رابط عام لصفحة الوظيفة.

### كيفية التنفيذ

1. افتح وولف فيش.
2. انقر على أيقونة المرفقات في حقل المحادثة واختر ملف بي دي اف لسيرتك الذاتية.
3. في مربع الرسالة، الصق نص الوصف الوظيفي كاملاً. إذا كان لديك رابط لإعلان الوظيفة، الصق ذلك الرابط بدلاً من ذلك.
4. أضف تعليمات واضحة مثل "خصص سيرتي الذاتية لهذا الدور" ليعرف وولف فيش ما تريد.
5. أرسل الرسالة.
6. انتظر حتى يعالج وولف فيش سيرتك الذاتية والوصف الوظيفي. يستغرق هذا عادةً أقل من دقيقة.
7. عند الانتهاء، سترى النتيجة في المحادثة. حمّل السيرة الذاتية المخصصة من مجلد مساحة العمل.

### ما ستحصل عليه

سينشئ وولف فيش مستند سيرة ذاتية جديد مخصص للوظيفة التي قدمتها. مع الملف، ستحصل على ملخص قصير يشرح ما تم تغييره ولماذا — أي المهارات تم إبرازها، وما تم إعادة ترتيبه، وكيف تم تعديل اللغة لتتناسب مع الدور. يساعدك هذا الملخص على مراجعة التغييرات قبل إرسال السيرة الذاتية لأي شخص.

### نصائح لأفضل النتائج

ابدأ بسيرة ذاتية أساسية كاملة ومحدثة. كلما كان لدى وولف فيش مادة أكثر للعمل عليها، كانت النسخة المخصصة أفضل. إذا كانت سيرتك الذاتية الأساسية تفتقر لوظائف أو مهارات حديثة، ستكون النتيجة كذلك.

الصق الوصف الوظيفي كاملاً، وليس فقط المسمى الوظيفي. التفاصيل مهمة — المتطلبات المحددة والمؤهلات المفضلة وحتى نبرة الإعلان كلها تساعد وولف فيش على إجراء تعديلات أذكى.

اقرأ دائماً ملخص التغييرات قبل استخدام السيرة الذاتية المخصصة. يقوم وولف فيش بعمل جيد، لكنك تعرف مسيرتك المهنية أفضل من أي شخص. مراجعة سريعة تضمن أن كل شيء دقيق ويُقرأ بالطريقة التي تريدها.

احتفظ بنسخة من سيرتك الذاتية الأصلية. ينشئ وولف فيش ملفاً جديداً ولن يحل محل الأصلي، لكن من الجيد الاحتفاظ بنسخة احتياطية من سيرتك الذاتية الأساسية وإبقائها في متناول اليد للمرة القادمة.

### البرومبت

<Note>أرفق سيرتك الذاتية كملف بي دي اف في المحادثة قبل إرسال هذا البرومبت.</Note>
...
افتح وولف فيش، أرفق سيرتك الذاتية، وجرّبها.
