...
يبحث Wolffish عن أبرز أخبار الذكاء الاصطناعي اليوم، ويكتب منشوراً على LinkedIn بأسلوبك، وينشره باستخدام جلسة Chrome الموجودة لديك. بدون واجهة LinkedIn API. بدون OAuth. مجرد بحث على الويب + تحكم بالحاسوب.
...
<iframe
  ...
  title="منشور أخبار الذكاء الاصطناعي على LinkedIn — عرض Wolffish"
  frameBorder="0"
...
أرسل هذا إلى Wolffish. يبحث ويكتب وينشر — محادثة واحدة.
...
بمجرد أن تثق في جودة الإخراج، أضف الموجِّه إلى `brain/brainstem/heartbeat.md` تحت عنوان جدولة. راجع [توثيق Heartbeat](/ar/configuration/heartbeat) لتنسيقات الجدولة (`Daily`، `Weekday`، `Weekly`، `Cron`).
