...
<Tabs>
  ...
  <Tab title="ما المخرجات التي عادت؟">
    قسم `Output` يحتوي على نتيجة الأداة الخام. هذا ما يُمرر مرة أخرى إلى LLM لاستجابته التالية. إذا بدت المخرجات خاطئة، فالخلل في الأداة/الإضافة وليس في Wolffish.
  </Tab>
</Tabs>
