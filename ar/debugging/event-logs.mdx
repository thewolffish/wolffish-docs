...
كل حدث يُطلق في Wolffish يتم تسجيله في ملف Markdown يومي. يمنحك هذا سجلاً زمنياً كاملاً لكل ما حدث — المدخلات والتصنيفات واستدعاءات LLM وتنفيذ الأدوات وقرارات الأمان وعمليات الذاكرة والمزيد.
