...
لقطات التصحيح هي أكثر أداة تصحيح مفيدة في Wolffish. تُظهر لك **بالضبط** محث النظام الذي تم تجميعه وإرساله إلى LLM في كل دور — بدون تجريد، بدون تلخيص، النص الحرفي.
...
<AccordionGroup>
  ...
  <Accordion title="ذاكرة خاطئة أو غير مرتبطة؟">
    ...
    - فهرس cortex يحتاج لإعادة بناء (احذف `cortex.db`، أعد تشغيل Wolffish)
  </Accordion>
...
<Tip>
إذا فعل Wolffish شيئاً خاطئاً، ففي 90% من الحالات الإجابة في لقطة التصحيح. النموذج لا يمكنه التصرف إلا بناءً على ما يراه — إذا لم تكن المعلومات الصحيحة في السياق، لم يكن بإمكان النموذج استخدامها.
</Tip>
