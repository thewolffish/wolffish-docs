...
description: "كيف يتواصل Wolffish — واجهة Electron، و Telegram، و WhatsApp"
---

# نظرة عامة على القنوات

يتواصل Wolffish من خلال ثلاث قنوات: واجهة سطح المكتب عبر Electron، وبوت Telegram، والمراسلة المباشرة عبر WhatsApp. تعمل القنوات الثلاث بنفس خط معالجة الذكاء — الفرق الوحيد هو كيفية وصول المدخلات وكيفية عرض المخرجات.
