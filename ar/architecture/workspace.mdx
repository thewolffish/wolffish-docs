...
يتضمن Wolffish عارض ملفات ومحرر Markdown مدمج — يمكنك تصفح وتعديل مساحة العمل بالكامل دون مغادرة التطبيق. لمعظم الحالات، هذا كل ما تحتاجه. يمكنك أيضاً فتح `~/.wolffish/workspace/` في أي محرر خارجي إذا فضّلت ذلك. بعض الأشياء المفيدة للفحص:
