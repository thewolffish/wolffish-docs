...
ملفات المعرفة هي الذاكرة الدائمة للوكيل — حقائق طويلة المدى تبقى إلى أجل غير مسمى ومتاحة دائماً في السياق. بينما تلتقط الأحداث ما حدث ويضغط التجميع الجدول الزمني، تُخزّن ملفات المعرفة ما *يعرفه* Wolffish عنك وعن عالمك وتفضيلاتك.
...
عندما تقول شيئاً مثل "تذكّر أنني أفضل conventional commits" أو "اسم مديرتي سارة"، يكتب الوكيل مباشرة في ملف المعرفة المناسب أثناء المحادثة. إجراءات `agents.core.md` توجّه Wolffish لتحديث المعرفة كلما تعلّم حقيقة جديدة طويلة المدى.
...
<Tabs>
  ...
  <Tab title="تصحيح حقائق">
    إذا كان لدى Wolffish معلومات قديمة:
  ...
  <Tab title="حذف حقائق">
    احذف السطر من ملف المعرفة، أو أخبر Wolffish:
