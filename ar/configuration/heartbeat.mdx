...
ملف النبض يُحدّد المهام المجدولة التي يُشغِّلها Wolffish بشكل مستقل. يقع في `brain/brainstem/heartbeat.md`، وتُحلّله وحدة brainstem عند بدء التشغيل وتُسجّله كمهام cron متكررة.
...
<Tip>
  يُعيد brainstem قراءة `heartbeat.md` عند بدء التشغيل. بعد تعديل الملف، أعد تشغيل Wolffish أو انتظر دورة تهيئة brainstem التالية.
</Tip>
