...
يربط تكامل GitHub تطبيق Wolffish بواجهة GitHub API لإدارة المستودعات والمشكلات وطلبات السحب وسير العمل والإصدارات والمزيد. يستخدم رمز وصول شخصي (PAT) للمصادقة.
...
يفصل Wolffish بين عمليات git المحلية وعمليات GitHub API عن بُعد:
