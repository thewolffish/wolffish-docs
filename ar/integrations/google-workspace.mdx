...
<Steps>
  ...
  <Step title="منح الصلاحيات">
    وافق على النطاقات المطلوبة. يطلب وولفيش صلاحيات قراءة/كتابة لـ Gmail و Drive و Calendar و Contacts و Tasks و Sheets.
  </Step>
  <Step title="الإكمال">
...
<Note>
  تُخزّن رموز OAuth محليًا في `~/.wolffish/workspace/config.json`. يستخدم وولفيش رمز التحديث لتجديد رموز الوصول بصمت عند انتهائها — لا حاجة لإعادة التفويض.
</Note>
...
إذا كان لديك حساب واحد فقط، يظل وولفيش يتطلب معامل `account` للاتساق ولتجنب الالتباس إذا أضفت حسابات أخرى لاحقًا.
