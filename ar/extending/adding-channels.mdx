...
description: "كيفية تنفيذ قناة اتصال جديدة لـ Wolffish"
---

# إضافة قناة جديدة

تربط القناة Wolffish بمنصة اتصال خارجية. واجهة سطح المكتب، Telegram، و WhatsApp كلها قنوات - تستقبل الرسائل من مصادر مختلفة لكنها توجهها عبر نفس خط أنابيب الدماغ.
...
قناتك تقرر كيف تُربط الخيوط الخارجية بمحادثات Wolffish:
