...
<Tip>
  أبسط طريقة لتسليم قدرة لأحدهم هي ضغط المجلد وإرساله — يُفلت ملف `.zip` على لوحة المُخيخ لديه فتصبح فعّالة. وللتوزيع المستمر، ادفعها إلى git بدلًا من ذلك (انظر [قدرات المجتمع](/ar/extending/community-capabilities)).
</Tip>
