...
description: "أنماط متقدمة لإضافات القدرات في وولفيش"
---
...
<Warning>
  ثبّت فقط الإضافات التي تثق بها. الإضافة الخبيثة لديها نفس صلاحيات وولفيش نفسه. راجع كود الإضافة قبل إضافتها لمساحة العمل، خاصة إضافات المجتمع.
</Warning>
...
<Tabs>
  ...
  <Tab title="الاختبار المباشر">
    حمّل وولفيش في وضع التطوير (`npm run dev`) وشغّل إضافتك عبر المحادثة. تحقق من:
