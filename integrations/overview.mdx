...
<CardGroup cols={2}>
  ...
  <Card title="Phone Notifications" icon="bell" href="/integrations/notifications">
  ...
  <Card title="Video Generation" icon="video" href="/integrations/video-generation">
...
For example, saying "check my email" leads the model to activate the Google capability and call the right tool (`google_gmail_search`, `google_gmail_read`, etc.) based on your intent. Activation is scoped to the conversation, so a background job loading GitHub never touches your live chat.
