...
<Info>
  Compaction jobs run through the brainstem's run pool — up to three jobs at once, and an overflow fire is queued rather than dropped. Summarization uses the same model your brain is configured with.
</Info>
