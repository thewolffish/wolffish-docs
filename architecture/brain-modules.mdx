...
- **Episodes** (`episodes/YYYY-MM-DD.md`): Daily conversation logs, appended every turn with no LLM call. Entries are origin-tagged (`## HH:MM [heartbeat] — …`) so heartbeat, procedure, and worker turns are distinguishable from chat
