...
| mimo-v2-pro | 256K | 16K | $0.20 / $2.00 | Previous generation pro model. |
| mimo-v2-omni | 256K | 16K | $0.08 / $0.80 | Multimodal. Vision and document input. |
| mimo-v2-flash | 256K | 16K | $0.01 / $0.30 | Ultra-cheap. Best for high-volume, low-complexity tasks. |

<Note>
  Cache write is currently free (promotional period). MiMo V2.5 Pro offers a 1M token context window — matching DeepSeek V4 Pro — at comparable input pricing.
</Note>
