...
To watch the workers, turn on **Verbose task results** in **Settings → Channels → In-App Chat** — WhatsApp and Telegram carry the same per-channel toggle, so workers narrate there too when it's on:
