...
|------|----------|---------------|--------------------------|----------|
| Cost-efficient | **DeepSeek** | deepseek-v4-flash | $0.14 / $0.28 | Default for most agentic tasks |
...
|-------|---------|------------|--------------------------|-------|
| **deepseek-v4-flash** | 1M | 32K | $0.14 / $0.28 | Auto-selected on connect. Frontier agentic performance, fast and cheap. Cached: $0.003/MTok. |
| deepseek-v4-pro | 1M | 32K | $0.44 / $0.87 | The heavier reasoning tier. Cached: $0.004/MTok. |
