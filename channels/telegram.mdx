...
- **Images** — screenshots, photos, diagrams (read directly by vision-capable models; text-only models receive a note with the file's name and path and can still operate on it with tools)
