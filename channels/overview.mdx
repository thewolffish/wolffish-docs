...
In the app, the conversations rail and History mark each conversation with a small **origin badge** — Telegram, WhatsApp, automation, or procedure run — so a mixed list stays legible. In-app chats carry no badge: the app is the default.
