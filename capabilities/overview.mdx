...
See [Creating Capabilities](/extending/creating-capabilities) for the full walkthrough, the three import shapes, and the rules an importable capability must follow.
