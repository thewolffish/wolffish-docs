...
<Tip>
  Start by reading the SKILL.md of any built-in capability to understand the pattern. Then create your own following the same structure. See [Creating Capabilities](/extending/creating-capabilities) for a step-by-step guide.
</Tip>
