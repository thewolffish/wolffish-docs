...
<AccordionGroup>
  ...
  <Accordion title="procedures — Manage saved prompts you run on demand">
    ...
    **Tools:**
    ...
    - `procedure_create` — Save a new procedure (title + self-contained prompt)
    - `procedure_edit` — Change a procedure's title and/or prompt
