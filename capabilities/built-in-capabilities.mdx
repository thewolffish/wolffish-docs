...
<AccordionGroup>
  <Accordion title="skills — Manage and author its own capabilities" defaultOpen>
    ...
    **Tools:**
    ...
    Changes persist and take effect on the next turn. This is how Wolffish extends itself without a code change — see [Creating Capabilities](/capabilities/creating-capabilities).
  </Accordion>
</AccordionGroup>
