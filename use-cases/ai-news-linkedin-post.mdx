...
Once you trust the output, add the prompt to `brain/brainstem/heartbeat.md` under a schedule heading. See the [Heartbeat docs](/configuration/heartbeat) for schedule formats (`Daily`, `Weekday`, `Weekly`, `Cron`).
